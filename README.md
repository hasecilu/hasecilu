...
- I play to be a sysadmin on my _smol_ Debian server
...
- My collection of config files for some applications [here](https://www.gitlab.com/hasecilu/dotfiles).
- I'm using Arch Linux with Hyprland/Openbox with some GNOME applications.
- Terminal is Alacritty + tmux and I'm using Neovim + LazyVim as text editor.

---

## Stats

![hasecilu's achivements](https://github-profile-trophy.vercel.app/?username=hasecilu&theme=tokyonight&margin-w=15&margin-h=15)
